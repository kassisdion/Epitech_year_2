...
MenuWin::MenuWin(MenuView *view) :
    Menu(createItems(), 1, view, victoireBitmap, victoireBitmapLen)
{
}
...
void MenuWin::onClick(unsigned int index, MenuItem &item)
{
    switch (index)
        {
            case 0:
